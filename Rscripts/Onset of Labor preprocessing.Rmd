...
funct_path=paste0(my_path,"/Onset of Labor csv/Onset of Labor Study Reanalysis PTB drug assay matching gates.csv")
path_to_penalization_file=paste0(my_path,"/Drug assay csv/penalization matrix drug assay.xlsx")
...
im_EGA_DOS = merge(x, select(TTL, c("EGA", "DOS")), by = "ID")
```
...
im_EGA_DOS_pen <- select(im_EGA_DOS, -one_of(discard))
```
