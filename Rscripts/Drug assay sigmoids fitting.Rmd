...
Loading log10_1.hand.median.model and log10_1.hand.individualmodel (Necessary only if you haven't run all the code above).
...
Function regrouping all the different class of models we applied to our data
